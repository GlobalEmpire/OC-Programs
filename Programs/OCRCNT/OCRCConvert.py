...
def main():
    ...
    print("There are 2 types:\n"
          "Level [1] [Default]: Uses imageio's subrectagles to optimise the video. great for a still or slow image.\n"
          "Level [2] [Gifsicle]: Uses Gifsicle to compress the images. Resulting in easier processing for OCRCNT.")
    try:
